...
function buildSystemPrompt(ctx) {
  ...
  return [
    ...
    `5a. RENDERABLE DIAGRAMS. For data-handling, climate, scientific-results, ordering / number-line, and similar questions, attach a diagram stimulus with a typed \`spec\` (currently supported: bar_graph, number_line). The renderer turns the spec into a real image embedded in the paper — preferred over a verbal "[Visual text — described below]" block. Only attach a diagram when interpreting it is part of the question; do not decorate. Always include altText alongside spec for accessibility and as a fallback.`,
