...
function buildSystemPrompt(ctx) {
  ...
  return [
    ...
    `5g. PHOTOGRAPHIC IMAGES. You MAY attach AT MOST ONE \`kind: "image"\` stimulus per paper, and only when the photo is genuinely required for a real-world appearance question. NEVER invent an imageId — only the catalogue ids listed below resolve. Photos and diagrams are different tools: use diagrams (bar_graph, number_line, food_chain) for STRUCTURAL or QUANTITATIVE content; use photos ONLY for REAL-WORLD APPEARANCE.
