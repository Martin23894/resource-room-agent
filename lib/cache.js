...
// Default TTL is 7 days, overridable with CACHE_TTL_SECONDS. The cache key
// includes a versioned prefix (e.g. `gen:v6:`) so a deploy that changes the
// response shape invalidates everything safely; teachers regenerating common
// cells (Maths Gr 6 T2 Test 50 marks etc.) within a week pay nothing on
// Anthropic, which is by far the largest cost line per call.
