...
const STRINGS = {
  English: {
    ...
    // Lesson worksheet (kid-mode) labels — friendlier than the formal
    // assessment cover. Used only when resourceType === 'Lesson'.
    lesson: {
      worksheetTitle: 'Time to practice',
      greeting:       'Try your best — you can do this!',
      nameLabel:      'Name',
      dateLabel:      'Date',
      marksUnit:      'pts',
      selfAssess:     'How did you find this?',
      selfAssessFaces: ['Easy', 'OK', 'Tricky'],
      wellDoneStamp:  'Well done!',
    },
  ...
  Afrikaans: {
    ...
    // Lesson worksheet (kid-mode) labels — Afrikaans variants.
    lesson: {
      worksheetTitle: 'Tyd om te oefen',
      greeting:       'Probeer jou bes — jy kan dit doen!',
      nameLabel:      'Naam',
      dateLabel:      'Datum',
      marksUnit:      'pte',
      selfAssess:     'Hoe het jy dit gevind?',
      selfAssessFaces: ['Maklik', 'Reg so', 'Moeilik'],
      wellDoneStamp:  'Mooi gedoen!',
    },
