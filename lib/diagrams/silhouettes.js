...
const SILHOUETTES = {
  ...
  // ── BATCH 6 · MORE BIRDS + REPTILES ────────────────────────────
  owl: `
    <ellipse cx="50" cy="36" rx="20" ry="18"/>
    <ellipse cx="50" cy="22" rx="18" ry="14"/>
    <path d="M34,12 L36,4 L42,16 Z"/>
    <path d="M66,12 L64,4 L58,16 Z"/>
    <circle cx="42" cy="22" r="6" fill="#fbf8f1"/>
    <circle cx="58" cy="22" r="6" fill="#fbf8f1"/>
    <circle cx="42" cy="22" r="3"/>
    <circle cx="58" cy="22" r="3"/>
    <circle cx="42" cy="22" r="1.4" fill="#fbf8f1"/>
    <circle cx="58" cy="22" r="1.4" fill="#fbf8f1"/>
    <path d="M48,28 L50,32 L52,28 Z"/>
    <path d="M40,42 Q44,50 50,52 Q56,50 60,42" stroke="#fbf8f1" stroke-width="1" fill="none"/>
    <line x1="44" y1="54" x2="44" y2="60" stroke="currentColor" stroke-width="1.6"/>
    <line x1="56" y1="54" x2="56" y2="60" stroke="currentColor" stroke-width="1.6"/>
  `,

  hawk: `
    <path d="M50,30 Q42,18 50,14 Q58,18 50,30 Z"/>
    <path d="M50,26 Q26,18 12,28 Q18,34 32,34 Q44,34 50,30 Z"/>
    <path d="M50,26 Q74,18 88,28 Q82,34 68,34 Q56,34 50,30 Z"/>
    <ellipse cx="50" cy="36" rx="9" ry="12"/>
    <path d="M44,46 L42,54 M50,48 L50,56 M56,46 L58,54" stroke="currentColor" stroke-width="1.4"/>
    <circle cx="50" cy="20" r="2.6"/>
    <path d="M52,20 L58,18 L54,22 Z"/>
    <circle cx="50" cy="20" r="0.8" fill="#fbf8f1"/>
  `,

  sparrow: `
    <ellipse cx="44" cy="36" rx="18" ry="11"/>
    <circle cx="62" cy="30" r="9"/>
    <path d="M70,28 L78,28 L74,32 Z"/>
    <circle cx="62" cy="28" r="1.4" fill="#fbf8f1"/>
    <path d="M30,32 Q22,28 22,38 Q28,38 32,36 Z"/>
    <path d="M28,38 Q24,46 28,52 Q32,46 32,42 Z"/>
    <line x1="42" y1="46" x2="40" y2="54" stroke="currentColor" stroke-width="1.6"/>
    <line x1="48" y1="46" x2="48" y2="54" stroke="currentColor" stroke-width="1.6"/>
  `,

  ostrich: `
    <ellipse cx="40" cy="32" rx="20" ry="12"/>
    <path d="M52,26 Q56,12 58,4 Q62,12 56,28 Z"/>
    <ellipse cx="60" cy="6" rx="5" ry="4"/>
    <path d="M64,6 L70,6 L66,10 Z"/>
    <circle cx="58" cy="4" r="1" fill="#fbf8f1"/>
    <line x1="32" y1="42" x2="30" y2="58" stroke="currentColor" stroke-width="2.4"/>
    <line x1="44" y1="42" x2="46" y2="58" stroke="currentColor" stroke-width="2.4"/>
    <path d="M28,58 L32,58 L30,60 Z"/>
    <path d="M44,58 L48,58 L46,60 Z"/>
    <path d="M22,30 Q12,28 8,34 Q14,38 22,36 Q14,42 8,46 Q18,42 22,40 Z"/>
  `,

  vulture: `
    <ellipse cx="46" cy="36" rx="22" ry="13"/>
    <ellipse cx="46" cy="20" rx="6" ry="8" fill="#fbf8f1" opacity="0.75"/>
    <ellipse cx="46" cy="20" rx="6" ry="8"/>
    <ellipse cx="46" cy="22" rx="4" ry="6" fill="#fbf8f1" opacity="0.6"/>
    <circle cx="44" cy="20" r="1" fill="#fbf8f1"/>
    <path d="M50,22 Q58,22 60,28 Q54,28 50,26 Z"/>
    <path d="M22,32 Q10,28 6,34 Q14,38 22,36 Z"/>
    <path d="M20,38 Q8,40 6,46 Q14,44 22,42 Z"/>
    <line x1="40" y1="48" x2="40" y2="56" stroke="currentColor" stroke-width="1.6"/>
    <line x1="50" y1="48" x2="50" y2="56" stroke="currentColor" stroke-width="1.6"/>
  `,

  stork: `
    <ellipse cx="42" cy="34" rx="18" ry="10"/>
    <path d="M52,28 Q56,16 56,8 Q60,16 58,30 Z"/>
    <ellipse cx="58" cy="8" rx="4" ry="3"/>
    <path d="M60,8 L80,6 L70,12 Z"/>
    <circle cx="56" cy="6" r="0.8" fill="#fbf8f1"/>
    <line x1="36" y1="42" x2="32" y2="58" stroke="currentColor" stroke-width="2"/>
    <line x1="44" y1="42" x2="46" y2="58" stroke="currentColor" stroke-width="2"/>
    <path d="M30,58 L36,58 L32,60 Z"/>
    <path d="M44,58 L50,58 L46,60 Z"/>
    <path d="M24,30 Q12,28 8,34 Q14,38 22,36 Z"/>
  `,

  kingfisher: `
    <ellipse cx="42" cy="36" rx="18" ry="10"/>
    <circle cx="58" cy="30" r="10"/>
    <path d="M64,28 L88,24 L80,32 Z"/>
    <circle cx="58" cy="28" r="1.4" fill="#fbf8f1"/>
    <path d="M58,18 Q54,12 56,8 Q60,12 62,18 Z"/>
    <path d="M28,32 Q16,28 12,34 Q20,38 28,36 Z"/>
    <path d="M30,42 Q20,46 16,54 Q24,50 30,46 Z"/>
    <line x1="38" y1="46" x2="36" y2="54" stroke="currentColor" stroke-width="1.6"/>
    <line x1="46" y1="46" x2="46" y2="54" stroke="currentColor" stroke-width="1.6"/>
  `,

  crow: `
    <ellipse cx="44" cy="36" rx="22" ry="11"/>
    <circle cx="64" cy="30" r="9"/>
    <path d="M70,28 L82,26 L74,32 Z"/>
    <circle cx="64" cy="28" r="1.2" fill="#fbf8f1"/>
    <path d="M22,32 Q10,30 6,36 Q14,40 24,38 Z"/>
    <path d="M22,38 Q12,42 8,52 Q18,46 24,44 Z"/>
    <line x1="40" y1="46" x2="38" y2="56" stroke="currentColor" stroke-width="1.8"/>
    <line x1="50" y1="46" x2="50" y2="56" stroke="currentColor" stroke-width="1.8"/>
  `,

  gecko: `
    <ellipse cx="44" cy="36" rx="22" ry="6"/>
    <ellipse cx="20" cy="34" rx="10" ry="7"/>
    <path d="M66,34 Q82,28 92,32 Q90,38 86,36 Q80,38 76,38 Q70,38 66,38 Z"/>
    <circle cx="14" cy="32" r="1.6" fill="#fbf8f1"/>
    <path d="M28,42 L22,52 L30,46 Z"/>
    <path d="M40,42 L34,54 L42,48 Z"/>
    <path d="M52,42 L46,54 L54,48 Z"/>
    <path d="M62,42 L58,52 L64,46 Z"/>
    <path d="M30,30 L22,22 L32,28 Z"/>
    <path d="M50,28 L42,20 L52,26 Z"/>
    <circle cx="36" cy="30" r="1" fill="#fbf8f1"/>
    <circle cx="48" cy="30" r="1" fill="#fbf8f1"/>
    <circle cx="56" cy="30" r="1" fill="#fbf8f1"/>
  `,

  chameleon: `
    <path d="M16,38 Q16,26 30,24 Q56,24 70,30 Q72,38 70,42 Q56,42 38,42 Q22,42 16,38 Z"/>
    <ellipse cx="68" cy="30" rx="8" ry="6"/>
    <path d="M62,22 L68,12 L72,22 Z"/>
    <circle cx="68" cy="30" r="3" fill="#fbf8f1"/>
    <circle cx="68" cy="30" r="1.6"/>
    <path d="M14,38 Q4,42 4,52 Q12,48 14,42 Q4,52 8,58 Q14,52 14,46 Z"/>
    <line x1="26" y1="42" x2="22" y2="52" stroke="currentColor" stroke-width="2"/>
    <line x1="36" y1="42" x2="34" y2="54" stroke="currentColor" stroke-width="2"/>
    <line x1="50" y1="42" x2="50" y2="54" stroke="currentColor" stroke-width="2"/>
    <line x1="62" y1="42" x2="64" y2="54" stroke="currentColor" stroke-width="2"/>
  `,

  tortoise: `
    <path d="M16,42 Q16,18 50,16 Q84,18 84,42 Q72,46 50,46 Q28,46 16,42 Z"/>
    <ellipse cx="50" cy="34" rx="22" ry="14" fill="#fbf8f1" opacity="0.4"/>
    <line x1="40" y1="20" x2="40" y2="42" stroke="#fbf8f1" stroke-width="1"/>
    <line x1="50" y1="18" x2="50" y2="42" stroke="#fbf8f1" stroke-width="1"/>
    <line x1="60" y1="20" x2="60" y2="42" stroke="#fbf8f1" stroke-width="1"/>
    <line x1="20" y1="32" x2="80" y2="32" stroke="#fbf8f1" stroke-width="1"/>
    <ellipse cx="78" cy="34" rx="8" ry="5"/>
    <circle cx="82" cy="32" r="1.2" fill="#fbf8f1"/>
    <ellipse cx="22" cy="46" rx="6" ry="4"/>
    <ellipse cx="38" cy="48" rx="6" ry="4"/>
    <ellipse cx="62" cy="48" rx="6" ry="4"/>
    <ellipse cx="78" cy="46" rx="6" ry="4"/>
  `,

  turtle: `
    <path d="M16,38 Q14,28 30,22 Q50,18 70,22 Q86,28 84,38 Q72,42 50,42 Q28,42 16,38 Z"/>
    <ellipse cx="50" cy="32" rx="22" ry="10" fill="#fbf8f1" opacity="0.35"/>
    <line x1="40" y1="22" x2="40" y2="42" stroke="#fbf8f1" stroke-width="0.8"/>
    <line x1="50" y1="20" x2="50" y2="42" stroke="#fbf8f1" stroke-width="0.8"/>
    <line x1="60" y1="22" x2="60" y2="42" stroke="#fbf8f1" stroke-width="0.8"/>
    <line x1="22" y1="32" x2="78" y2="32" stroke="#fbf8f1" stroke-width="0.8"/>
    <ellipse cx="78" cy="34" rx="8" ry="5"/>
    <circle cx="82" cy="32" r="1.2" fill="#fbf8f1"/>
    <path d="M14,38 Q4,42 0,46 Q10,46 18,42 Z"/>
    <path d="M30,42 Q24,52 18,52 Q26,46 30,46 Z"/>
    <path d="M70,42 Q76,52 82,52 Q74,46 70,46 Z"/>
    <path d="M22,30 Q12,26 8,30 Q16,34 22,34 Z"/>
  `,

  crocodile: `
    <ellipse cx="50" cy="38" rx="34" ry="6"/>
    <path d="M50,32 Q72,30 92,32 L92,40 Q72,42 50,40 Z"/>
    <line x1="60" y1="34" x2="58" y2="38" stroke="#fbf8f1" stroke-width="0.8"/>
    <line x1="68" y1="34" x2="66" y2="38" stroke="#fbf8f1" stroke-width="0.8"/>
    <line x1="76" y1="34" x2="74" y2="38" stroke="#fbf8f1" stroke-width="0.8"/>
    <line x1="84" y1="34" x2="82" y2="38" stroke="#fbf8f1" stroke-width="0.8"/>
    <circle cx="82" cy="34" r="1.4" fill="#fbf8f1"/>
    <path d="M28,38 Q14,32 4,36 Q14,38 24,40 Z"/>
    <path d="M86,40 L92,44 L86,42 Z"/>
    <path d="M30,42 L26,52 L34,46 Z"/>
    <path d="M44,42 L40,54 L48,48 Z"/>
    <path d="M58,42 L54,54 L62,48 Z"/>
    <path d="M70,42 L66,52 L74,46 Z"/>
    <path d="M28,30 L26,22 L32,30 Z"/>
    <path d="M48,30 L46,24 L52,30 Z"/>
    <path d="M68,30 L66,24 L72,30 Z"/>
  `,

  // ── BATCH 7 · PLANTS + DECOMPOSERS ─────────────────────────────
  wildflower: `
    <rect x="48" y="32" width="4" height="24"/>
    <path d="M50,30 Q40,20 32,28 Q42,32 50,32 Z"/>
    <path d="M50,30 Q60,20 68,28 Q58,32 50,32 Z"/>
    <path d="M50,28 Q44,18 50,10 Q56,18 50,28 Z"/>
    <path d="M50,32 Q42,38 38,46 Q46,40 50,36 Z"/>
    <path d="M50,32 Q58,38 62,46 Q54,40 50,36 Z"/>
    <circle cx="50" cy="30" r="5" fill="#fbf8f1"/>
    <circle cx="50" cy="30" r="2.4"/>
    <path d="M48,40 Q42,40 38,46 Q44,44 48,42 Z"/>
    <path d="M52,40 Q58,40 62,46 Q56,44 52,42 Z"/>
    <path d="M0,57 Q50,55 100,57 L100,60 L0,60 Z" opacity="0.4"/>
  `,

  fynbos: `
    <ellipse cx="30" cy="34" rx="14" ry="14"/>
    <ellipse cx="50" cy="28" rx="16" ry="18"/>
    <ellipse cx="70" cy="34" rx="14" ry="14"/>
    <ellipse cx="40" cy="44" rx="10" ry="6"/>
    <ellipse cx="60" cy="44" rx="10" ry="6"/>
    <circle cx="44" cy="20" r="3" fill="#fbf8f1"/>
    <circle cx="56" cy="22" r="3" fill="#fbf8f1"/>
    <circle cx="32" cy="32" r="2" fill="#fbf8f1"/>
    <circle cx="68" cy="32" r="2" fill="#fbf8f1"/>
    <path d="M0,57 Q50,55 100,57 L100,60 L0,60 Z" opacity="0.4"/>
  `,

  acacia: `
    <rect x="46" y="34" width="8" height="22"/>
    <path d="M16,30 Q20,22 30,20 Q44,12 50,12 Q56,12 70,20 Q80,22 84,30 Q72,34 50,34 Q28,34 16,30 Z"/>
    <ellipse cx="50" cy="22" rx="8" ry="4" fill="#fbf8f1" opacity="0.35"/>
    <ellipse cx="32" cy="28" rx="6" ry="3" fill="#fbf8f1" opacity="0.35"/>
    <ellipse cx="68" cy="28" rx="6" ry="3" fill="#fbf8f1" opacity="0.35"/>
    <path d="M0,57 Q50,55 100,57 L100,60 L0,60 Z" opacity="0.4"/>
  `,

  cabbage: `
    <ellipse cx="50" cy="38" rx="26" ry="20"/>
    <ellipse cx="50" cy="36" rx="22" ry="16" fill="#fbf8f1" opacity="0.3"/>
    <ellipse cx="50" cy="36" rx="16" ry="11"/>
    <ellipse cx="50" cy="34" rx="12" ry="7" fill="#fbf8f1" opacity="0.3"/>
    <path d="M28,34 Q22,38 22,42" stroke="#fbf8f1" stroke-width="1" fill="none"/>
    <path d="M72,34 Q78,38 78,42" stroke="#fbf8f1" stroke-width="1" fill="none"/>
    <path d="M50,18 Q44,20 42,26" stroke="#fbf8f1" stroke-width="1" fill="none"/>
    <path d="M50,18 Q56,20 58,26" stroke="#fbf8f1" stroke-width="1" fill="none"/>
    <ellipse cx="50" cy="32" rx="3" ry="2" fill="#fbf8f1"/>
  `,

  maize: `
    <rect x="48" y="22" width="4" height="36"/>
    <path d="M50,22 Q42,16 36,22 Q44,22 50,26 Z"/>
    <path d="M50,32 Q42,28 34,34 Q44,34 50,36 Z"/>
    <path d="M50,42 Q42,40 34,46 Q44,46 50,46 Z"/>
    <path d="M50,22 Q58,16 64,22 Q56,22 50,26 Z"/>
    <path d="M50,32 Q58,28 66,34 Q56,34 50,36 Z"/>
    <path d="M50,42 Q58,40 66,46 Q56,46 50,46 Z"/>
    <ellipse cx="58" cy="20" rx="6" ry="14"/>
    <line x1="56" y1="10" x2="58" y2="2" stroke="currentColor" stroke-width="0.8"/>
    <line x1="60" y1="10" x2="62" y2="2" stroke="currentColor" stroke-width="0.8"/>
    <circle cx="56" cy="14" r="1" fill="#fbf8f1"/>
    <circle cx="60" cy="14" r="1" fill="#fbf8f1"/>
    <circle cx="56" cy="18" r="1" fill="#fbf8f1"/>
    <circle cx="60" cy="18" r="1" fill="#fbf8f1"/>
    <circle cx="56" cy="22" r="1" fill="#fbf8f1"/>
    <circle cx="60" cy="22" r="1" fill="#fbf8f1"/>
    <circle cx="56" cy="26" r="1" fill="#fbf8f1"/>
    <circle cx="60" cy="26" r="1" fill="#fbf8f1"/>
  `,

  wheat: `
    <line x1="50" y1="58" x2="50" y2="22" stroke="currentColor" stroke-width="2"/>
    <ellipse cx="50" cy="14" rx="3" ry="8"/>
    <ellipse cx="46" cy="16" rx="2.4" ry="6" transform="rotate(-25 46 16)"/>
    <ellipse cx="54" cy="16" rx="2.4" ry="6" transform="rotate(25 54 16)"/>
    <ellipse cx="44" cy="22" rx="2.4" ry="5" transform="rotate(-30 44 22)"/>
    <ellipse cx="56" cy="22" rx="2.4" ry="5" transform="rotate(30 56 22)"/>
    <ellipse cx="42" cy="28" rx="2.4" ry="5" transform="rotate(-35 42 28)"/>
    <ellipse cx="58" cy="28" rx="2.4" ry="5" transform="rotate(35 58 28)"/>
    <line x1="50" y1="6" x2="50" y2="-2" stroke="currentColor" stroke-width="0.8"/>
    <line x1="46" y1="8" x2="42" y2="2" stroke="currentColor" stroke-width="0.8"/>
    <line x1="54" y1="8" x2="58" y2="2" stroke="currentColor" stroke-width="0.8"/>
    <path d="M50,40 Q40,38 36,42 Q44,42 50,42 Z"/>
    <path d="M50,40 Q60,38 64,42 Q56,42 50,42 Z"/>
    <path d="M0,57 Q50,55 100,57 L100,60 L0,60 Z" opacity="0.4"/>
  `,

  mushroom: `
    <path d="M22,30 Q22,12 50,8 Q78,12 78,30 Q66,32 50,32 Q34,32 22,30 Z"/>
    <rect x="42" y="30" width="16" height="22"/>
    <ellipse cx="42" cy="22" rx="3" ry="2" fill="#fbf8f1"/>
    <ellipse cx="60" cy="20" rx="3" ry="2" fill="#fbf8f1"/>
    <ellipse cx="50" cy="14" rx="3" ry="2" fill="#fbf8f1"/>
    <ellipse cx="34" cy="26" rx="2" ry="1.4" fill="#fbf8f1"/>
    <ellipse cx="66" cy="26" rx="2" ry="1.4" fill="#fbf8f1"/>
    <line x1="46" y1="36" x2="46" y2="50" stroke="#fbf8f1" stroke-width="1"/>
    <line x1="54" y1="36" x2="54" y2="50" stroke="#fbf8f1" stroke-width="1"/>
    <ellipse cx="50" cy="54" rx="14" ry="3" opacity="0.5"/>
  `,

  lichen: `
    <path d="M14,40 Q10,28 22,24 Q34,22 38,30 Q44,22 56,24 Q66,22 72,30 Q86,30 88,40 Q82,46 72,46 Q66,52 54,48 Q48,52 38,48 Q26,50 18,46 Q12,46 14,40 Z"/>
    <circle cx="26" cy="34" r="3" fill="#fbf8f1"/>
    <circle cx="40" cy="32" r="2" fill="#fbf8f1"/>
    <circle cx="58" cy="34" r="3" fill="#fbf8f1"/>
    <circle cx="74" cy="36" r="2" fill="#fbf8f1"/>
    <circle cx="34" cy="42" r="1.4" fill="#fbf8f1"/>
    <circle cx="50" cy="40" r="2.4" fill="#fbf8f1"/>
    <circle cx="66" cy="42" r="1.4" fill="#fbf8f1"/>
    <circle cx="22" cy="42" r="1" fill="#fbf8f1"/>
    <circle cx="44" cy="46" r="1" fill="#fbf8f1"/>
    <circle cx="62" cy="46" r="1" fill="#fbf8f1"/>
  `,

  algae: `
    <path d="M14,58 Q14,40 18,30 Q22,40 20,58 Z"/>
    <path d="M28,58 Q26,32 34,16 Q34,32 32,58 Z"/>
    <path d="M44,58 Q42,38 48,22 Q48,38 48,58 Z"/>
    <path d="M58,58 Q56,30 64,12 Q64,32 62,58 Z"/>
    <path d="M74,58 Q72,40 80,28 Q78,40 78,58 Z"/>
    <path d="M88,58 Q88,44 92,36 Q92,44 92,58 Z"/>
    <circle cx="22" cy="38" r="1.6" fill="#fbf8f1"/>
    <circle cx="34" cy="28" r="1.6" fill="#fbf8f1"/>
    <circle cx="48" cy="32" r="1.6" fill="#fbf8f1"/>
    <circle cx="60" cy="22" r="1.6" fill="#fbf8f1"/>
    <circle cx="78" cy="34" r="1.6" fill="#fbf8f1"/>
  `,

  seaweed: `
    <path d="M22,58 Q22,38 30,30 Q26,42 30,52 Q34,40 38,30 Q34,46 38,58 Z"/>
    <path d="M50,58 Q48,30 56,16 Q52,30 56,42 Q60,28 64,16 Q60,34 64,58 Z"/>
    <path d="M76,58 Q74,38 82,28 Q78,40 82,50 Q86,38 90,28 Q86,46 90,58 Z"/>
    <ellipse cx="20" cy="58" rx="14" ry="2"/>
    <ellipse cx="56" cy="58" rx="16" ry="2"/>
    <ellipse cx="82" cy="58" rx="14" ry="2"/>
  `,

  reed: `
    <line x1="22" y1="58" x2="22" y2="14" stroke="currentColor" stroke-width="2"/>
    <line x1="36" y1="58" x2="36" y2="10" stroke="currentColor" stroke-width="2"/>
    <line x1="50" y1="58" x2="50" y2="6"  stroke="currentColor" stroke-width="2"/>
    <line x1="64" y1="58" x2="64" y2="10" stroke="currentColor" stroke-width="2"/>
    <line x1="78" y1="58" x2="78" y2="14" stroke="currentColor" stroke-width="2"/>
    <ellipse cx="22" cy="12" rx="2.6" ry="6"/>
    <ellipse cx="36" cy="8"  rx="2.6" ry="6"/>
    <ellipse cx="50" cy="4"  rx="2.6" ry="6"/>
    <ellipse cx="64" cy="8"  rx="2.6" ry="6"/>
    <ellipse cx="78" cy="12" rx="2.6" ry="6"/>
    <line x1="22" y1="6"  x2="22" y2="0" stroke="currentColor" stroke-width="0.8"/>
    <line x1="36" y1="2"  x2="36" y2="-4" stroke="currentColor" stroke-width="0.8"/>
    <line x1="50" y1="-2" x2="50" y2="-8" stroke="currentColor" stroke-width="0.8"/>
    <line x1="64" y1="2"  x2="64" y2="-4" stroke="currentColor" stroke-width="0.8"/>
    <line x1="78" y1="6"  x2="78" y2="0"  stroke="currentColor" stroke-width="0.8"/>
    <path d="M0,57 Q50,55 100,57 L100,60 L0,60 Z" opacity="0.4"/>
  `,

  fungus: `
    <ellipse cx="30" cy="48" rx="10" ry="3" opacity="0.55"/>
    <ellipse cx="50" cy="50" rx="14" ry="3" opacity="0.55"/>
    <ellipse cx="74" cy="48" rx="10" ry="3" opacity="0.55"/>
    <path d="M22,42 Q22,30 30,28 Q38,30 38,42 Q34,44 30,44 Q26,44 22,42 Z"/>
    <rect x="28" y="42" width="4" height="8"/>
    <path d="M40,42 Q40,24 50,20 Q60,24 60,42 Q56,46 50,46 Q44,46 40,42 Z"/>
    <rect x="48" y="42" width="4" height="10"/>
    <path d="M64,40 Q64,28 74,26 Q84,28 84,40 Q80,44 74,44 Q68,44 64,40 Z"/>
    <rect x="72" y="40" width="4" height="10"/>
    <ellipse cx="30" cy="34" rx="2" ry="1.2" fill="#fbf8f1"/>
    <ellipse cx="50" cy="28" rx="2" ry="1.2" fill="#fbf8f1"/>
    <ellipse cx="74" cy="32" rx="2" ry="1.2" fill="#fbf8f1"/>
  `,

  bacteria: `
    <ellipse cx="22" cy="22" rx="8" ry="4" transform="rotate(-20 22 22)"/>
    <ellipse cx="38" cy="14" rx="8" ry="4" transform="rotate(15 38 14)"/>
    <ellipse cx="58" cy="22" rx="8" ry="4" transform="rotate(-30 58 22)"/>
    <ellipse cx="80" cy="16" rx="8" ry="4" transform="rotate(20 80 16)"/>
    <circle cx="20" cy="40" r="5"/>
    <circle cx="40" cy="36" r="5"/>
    <circle cx="58" cy="42" r="5"/>
    <circle cx="78" cy="38" r="5"/>
    <ellipse cx="30" cy="50" rx="9" ry="4" transform="rotate(15 30 50)"/>
    <ellipse cx="60" cy="52" rx="9" ry="4" transform="rotate(-15 60 52)"/>
    <ellipse cx="84" cy="50" rx="6" ry="4"/>
    <circle cx="22" cy="40" r="1.4" fill="#fbf8f1"/>
    <circle cx="40" cy="36" r="1.4" fill="#fbf8f1"/>
    <circle cx="58" cy="42" r="1.4" fill="#fbf8f1"/>
    <circle cx="78" cy="38" r="1.4" fill="#fbf8f1"/>
  `,
};
